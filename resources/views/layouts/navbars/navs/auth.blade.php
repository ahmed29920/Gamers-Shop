...
?>
<nav id="navbar" class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <div class="photo">
                            <img src="{{ Auth::user()->gravatar }}" alt="{{ __('Profile Photo') }}">
                        </div>
                ...
                @if ($user == 1)
                    <li class=" nav-item">
                        <a href="{{ route('cartList') }}" class="contact-logo cart-logo nav-link"
                            style="width: max-content;"><i class="fas fa-shopping-cart"> (<span class="cart-counter">
                                    {{ $cart }}</span>) </i> </a>
                    </li>
                    <li class="nav-item">
                        <a href="" class="nav-link" style="width: max-content;"><i
                                class="tim-icons icon-bag-16 ">(<span> 0 </span>)</i> </a>
                    </li>
                @endif
