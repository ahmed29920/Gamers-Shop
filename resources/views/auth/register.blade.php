        ...
        <div class="col-md-5 ml-auto">
            <div class="info-area info-horizontal mt-5">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Recharge Game Cards') }}</h3>
                    <p class="description">
                        {{ __('We\'ve created the game cards campaign of the website. It was a very interesting collaboration.') }}
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Rapid Response') }}</h3>
                    <p class="description">
                        {{ __('We\'ve Rapid Response. To satisfy all our customers.') }}
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
        ...
        <div class="col-md-7 mr-auto">
            <div class="card card-register card-white">
                <div class="card-header">
                    ...
                    <h4 class="card-title me-5"> {{ __('Register') }}</h4>
                </div>
